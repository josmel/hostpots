...
(function () {
    define('manageTags2', ['lib_fancybox', 'lib_underscore', 'lib_chosen', 'lib_jqutils', 'alert'], function () {
...
//                        groups_id: idParent
            ...
            saveTags: function () {
                ...
                return $.ajax({
                    url: "/admclient/campanias/insert-free",
                    method: "GET",
                    data: {
...
//                        return echo("Data have been updated");
                        swal('Agregado', 'Se agrego la campaña al Cliente.', 'success');
                        return functions.showInitialTable();
                    },
                    error: function () {
                        utils.loader($("body"), false);
