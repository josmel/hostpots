...
(function () {
    define('manageTags4', ['lib_fancybox', 'lib_underscore', 'lib_chosen', 'lib_jqutils', 'alert'], function () {
        ...
        functions = {
            ...
            saveTags: function () {
                ...
                return $.ajax({
                    url: "/admclient/equipment/insert-free",
                    method: "GET",
                    data: {
...
//                        return echo("Data have been updated");
                        swal('Agregado', 'Se agrego el equipo al Cliente.', 'success');
                        return functions.showInitialTable();
                    },
                    error: function () {
                        utils.loader($("body"), false);
