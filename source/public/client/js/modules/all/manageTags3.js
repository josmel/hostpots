...
(function () {
    define('manageTags3', ['lib_fancybox', 'lib_underscore', 'lib_chosen', 'lib_jqutils', 'alert'], function () {
        ...
        st = {
            ...
            tag: '.tag-groups',
            tagMore: '.more-groups',
            tplTags: '#addTagsGroups',
            select: '.multiselect-custom',
            tagDelete: '.tag-groups .icon-remove'
        };
        dom = {};
        catchDom = function () {
            dom.table = $(st.table);
        ...
        functions = {
            ...
            addExerciseModal: function (obj) {
                 var idParent;
//                idParent = obj.parents(".more-exercise").data("id");
                $.ajax({
                    url: "/admclient/groups/groups-free",
                     method: "GET",
                    data: {
//                        groups_id: idParent
                    },
            ...
            saveTags: function () {
                ...
                return $.ajax({
                    url: "/admclient/groups/insert-free",
                    method: "GET",
                    data: {
...
//                        return echo("Data have been updated");
                        swal('Agregado', 'Se agrego el Grupo al Cliente.', 'success');
                        return functions.showInitialTable();
                    },
                    error: function () {
                        utils.loader($("body"), false);
