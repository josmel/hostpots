    ...
    <div class="l-page">
      ...
      <div id="wrapper"><br><br><br><br>
        <div class="content_soporte">
          <form data-parsley-validate class="formSoporte row">
            <div class="columna1">
              ...
              <div class="form_control">
                ...
                <input type="text" name="telefono" required data-parsley-type="number">
              </div>
          ...
          <ul>
            <li><a href="#"><i class="icon icon-email"></i></a><span>hola@cligo.pe</span></li>
            <li><a href="#"><i class="icon icon-phone"></i></a><span>Ca. Monte Carmelo 310 of. 101, Surco, Lima – Perú</span></li>
            <li><a href="#"><i class="icon icon-pin"></i></a><span>981 695 515 / 945 838 725</span></li>
          </ul>
        </div>
      </div>
    </div>
