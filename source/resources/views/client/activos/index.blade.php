    ...
    <div class="l-page">
      ...
      <div id="wrapper">
        <div class="filtros">
          <ul>
            ...
            <li><a href="/admclient/solicitar/excel?year=0000&amp;month=00&amp;day=00" id="url_report">
                <button>EXP A EXCEL</button></a></li>
          </ul>
        </div>
      ...
      <script type="text/template" class="row4Table">
        <tr data-id="<%= id %>" class="<%= css_class %>">
          <td data-title="Cód">
            <div><a href="detalle-activos/<%= id %>"><%= id %></a></div>
          </td>
          <td data-title="Tipo">
            <div> <a href="detalle-activos/<%= id %>"><%= delivery_type_name %></a></div>
          </td>
          <td data-title="Destino">
            <div><a href="detalle-activos/<%= id %>"><%= destination_address %></a></div>
          </td>
          <td data-title="Contacto">
            <div><a href="detalle-activos/<%= id %>"><%= contact_name %> </a></div>
          </td>
          <td data-title="Estado">
            <div><a href="detalle-activos/<%= id %>"><%= delivery_state_name %></a></div>
          </td>
          <td data-title="TimeStamp">
            <div><a href="detalle-activos/<%= id %>"><%= publish_time %></a></div>
          </td>
          <td data-title="Fecha">
            <div><a href="detalle-activos/<%= id %>"><%= publish_date %></a></div>
          </td>
          <td data-title="Recibo">
            <div><a href="#"><img src="{{asset('client/img/recibo.png')}}" alt=""></a></div>
          </td>
          <td data-title="Tarifa"> 
            <div> <a href="detalle-activos/<%= id %>"><%= price %></a></div>
          </td>
        </tr>
      </script>
    </div>
