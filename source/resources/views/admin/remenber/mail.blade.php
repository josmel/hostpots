                      ...
                      <td class="wrapper last">
                        <table class="twelve columns">
                          <tr>
                            ...
                            <td style="text-align:right; vertical-align:middle;" class="six sub-columns last"><span class="template-label">IBODY FORM</span></td>
          ...
          <table class="container">
            <tr>
              <td>
                ...
                <p class="lead">¿Has olvidado la contraseña de tu cuenta ? No te preocupes, puedes solucionarlo fácilmente accediendo al siguiente link<a href="{{Request::root()}}/remenber/{{$token}}"> restablecer</a></p>
              </td>
            </tr>
          </table>
        </center>
